...
public abstract class BasicController extends DefaultController {
	...
	protected BasicController(UserRequest ureq, WindowControl wControl,
		...
		Class<?> cl = this.getClass();
		this.translator = Util.createPackageTranslator(cl, getLocale(), fallBackTranslator);
		this.velocity_root = Util.getPackageVelocityRoot(cl);
		this.logger = Tracing.createLoggerFor(cl);
	}
